...
export default function pointageScreen({ navigation, route }) {
  const image = require('../../assets/icons/bg.png'); // replace with your image file path
  const { firstName, lastName } = route.params.user; // retrieve user's data

  return (
    <ImageBackground source={image} style={styles.container}>
      <View>
        <Text style={styles.title}>Bienvenue, {firstName} {lastName}</Text>
      </View>

...
import { StyleSheet, Text, View, Button,  ImageBackground, Image, Pressable, Animated, Modal, TouchableOpacity } from 'react-native';
  ...
  return (
    <ImageBackground source={require('../../assets/bg2.png')}style={styles.container}>
       ...
       <View style={styles.v2}>
        <Pressable >
          <Text style={styles.txt1}>Départ</Text>
        </Pressable>
       </View>
       ...
       <ModalPoup visible={visible}>
        ...
        {`Bonjour ${employeeName}, vous avez confirmé à ${currentDateTime.toLocaleTimeString()}`}
        </Text>
      </ModalPoup>
